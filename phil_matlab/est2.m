function [TRUTH,a,x1,TOC]=est2(PH,print,tag_g,mac,...
...
[t,Q_obs,k_1,k_2,k_3,p_1,p_2,p_3,p_4,lambda,x,CONTROL,CONTROL_PH,beta_O,beta_B]=...
    data_prep_bg(mac,tag_g,control_size,est_version,pollfish,BOOT,RLENGTH,  1  , cd_dir); %%% THIS USES REAL DATA
...
if ph_controls(1)==3
    PH_C = [ones(size(CONTROL_PH,1),1) CONTROL_PH CONTROL_PH(:,2).^2];
end
...
if real_data~=1
            ...
            data_prep_bg(mac,tag_g,control_size,est_version,pollfish,BOOT,RLENGTH,  0  );
