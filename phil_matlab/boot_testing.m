function [next_level_index,boot_sample,boot_sample_index,next_level_index_2,boot_sample_2] = boot_testing(index,index_2)
...
index_id = (1:length(index))';
index_id_start_values=cumsum(index)-index+1;

    boot_sample_index   = datasample(index_id,length(index_id),1);
