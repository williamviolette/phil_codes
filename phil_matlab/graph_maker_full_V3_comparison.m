function [solutions1, choices1, mean_utility1, F_MAX1, SOL_MAX1, sharing1, US_TOTAL] = graph_maker_full_V3_comparison(F_GRID,TRIALS,groups,...
...
for r=1:TRIALS
        ...
        if US_TOTAL(r,1)<0
            TU=TU.*-100; %% GET RID OF IMPLAUSIBLE VALUES!! 
        end
