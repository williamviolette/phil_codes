%{
function h = graph_time_v4_groups(print,tag,mac,size_smp,...
                    ...
                    PH_COUNTER,group_percentile,COST_INPUTS)
%}
...
sim_build_normc_real_data_smm_v5_more_moments_groupings(print,tag,mac,size_smp,...
                    ...
                    a_start,sto,reps,...
                    sort_condition,split_F_option,transfer_option,smm_est_option,...
                    real_data,TUNE,BOOT,boot_max,boot_estimates,alt_sample,est_opt);
...
dlmwrite(strcat(table_pre,tagline,'_optimal_prices_groups.csv'),[F_MAX1 SOL_MAX1],'delimiter',',','precision',15)
...
RESULTS_MATRIX = [  F_GRID ...
 ...
 csvwrite(strcat(table_pre,tagline,'_1_groups.csv'),RESULTS_MATRIX);
