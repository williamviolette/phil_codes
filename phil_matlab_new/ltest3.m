function  h = ltest3(input,cobs,wobs,p1,p2,y)
...
v1 = exp(u(a,g,p1,y )./y + u(a,g,p1,y    )./y);
v2 = exp(u(a,g,p1,y - F )./y + u(a,g,p1,y - F)./y);
v3 = exp(u(a,g,p1,y - F )./y + u(a,g,p1,y - F)./y);
...
cprob1 = 2.*cprob1_b./(2.*cprob1_b + cprob2_b + cprob3_b);
...
wprob = normpdf( (wobs - w(a,g,p1)),0,sig ).*cprob1 ...
      ...
      + normpdf( (wobs - w(a,g,p1) - w(a,g,p1)),0,sig ).*cprob3 ;

h = -1.*sum( (cobs==1).*log(cprob1) + (cobs==2).*log(cprob2) ...
