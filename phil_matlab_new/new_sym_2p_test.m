...
syms y p1i p1r p2i p2r a1 a2 g g1 g2 w x F l ws wbar1 wbar2
assume(y>0)
assume(p1i>0)
assume(p1r>0)
assume(p2i>0)
...
[wa1,xa1,la1]  =  solve([dw,dx,dl],[w,x,l]);

ua1 = simplify(subs(u,[w,x],[wa1,xa1]));
ua2 = subs(ua1,[a1,g1],[a2,g2]);
...
ws1a = subs(ws1,wbar2,ws2); % substitute ws2 in for ws1  
ws1d = simplify(solve(ws1a - wbar1,wbar1)); % solve for the wbar that solves  
ws2d = subs(ws1d,[a1,g1,a2,g2],[a2,g2,a1,g1]); % create optimal 2 by swapping alpha and gammas

xs1d = simplify(subs(xs1,wbar2,ws2d)); % create optimal x by swapping the bar2 for the demand2


us1 = simplify(subs(u,[w,x],[ws1d,xs1d]))

us2 = subs(us1,[a1,g1,a2,g2],[a2,g2,a1,g1])
