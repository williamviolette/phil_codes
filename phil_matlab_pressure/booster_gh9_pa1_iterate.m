...
if data==1
    ...
    for r=1:1
        ...
        cs = readmatrix('/Users/williamviolette/Documents/Philippines/phil_analysis/phil_temp/booster_sample_date_pa1.csv');
...
%             D = D(:,2:end);
           ...
           sig  = 17;
           siga = 230;
         alpha0 = [ 16.8;             2.4;     .27;       3.28;       -3.19;  0;     2.38 ];
          A = [ ones(size(wobs,1),1)   hhsize    hhemp     good_job      cmax   cch   treated  ];

%           alpha0 = [ 16.8;             2.4;     .27;       3.28;       -3.19;     2.38 ];
%           A = [ ones(size(wobs,1),1)   hhsize    hhemp     good_job      cmax    treated  ];
