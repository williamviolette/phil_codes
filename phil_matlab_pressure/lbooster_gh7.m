function  [VAL,G,H] = lbooster_gh7(input,A,T,Tb,wobs,bobs,p_i,y,c,given)
...
%             i=1
            ...
            [EV,OV,KV,UV,AV,AVB,TV,TVB] = ghu7_input(AC,A_1,A_2,TC,TCb,T_1,T_2,T_1b,T_2b,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [valw,gw,hw] =  ghu7(AC,AV,AVB,A_1,A_2,EV,KV,OV,TC,TCb,TV,TVB,T_1,T_2,T_1b,T_2b,UV,alpha1,alpha0_1,alpha0_2,bobs,es,nc,np,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
...
%             i=1
            ...
            [EV,OV,KV,UV,AV,AVB,TV,TVB] = ghu7_input(AC,A_1,A_2,TC,TCb,T_1,T_2,T_1b,T_2b,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [~,gw,hw] =  ghu7(AC,AV,AVB,A_1,A_2,EV,KV,OV,TC,TCb,TV,TVB,T_1,T_2,T_1b,T_2b,UV,alpha1,alpha0_1,alpha0_2,bobs,es,nc,np,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
...
%             i=1;
            ...
            [EV,OV,KV,UV,AV,AVB,TV,TVB] = ghu7_input(AC,A_1,A_2,TC,TCb,T_1,T_2,T_1b,T_2b,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [~,~,hw] =  ghu7(AC,AV,AVB,A_1,A_2,EV,KV,OV,TC,TCb,TV,TVB,T_1,T_2,T_1b,T_2b,UV,alpha1,alpha0_1,alpha0_2,bobs,es,nc,np,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
