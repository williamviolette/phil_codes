function  [VAL,G,H] = lbooster_gh8(input,A,T,Tb,wobs,bobs,p_i,y,c,given)
...
T_2b = 0;
TCb = Tb*t0;
[EV,OV,KV,UV,AV,AVB,TV,TVB] = ghu8_input(AC,A_1,A_2,TC,TCb,T_1,T_2,T_1b,T_2b,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
[valw] = ghu8_vj(AC,AV,AVB,A_1,A_2,EV,KV,OV,TC,TCb,TV,TVB,T_1,T_2,T_1b,T_2b,UV,alpha1,alpha0_1,alpha0_2,bobs,nc,np,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
VAL=sum(valw);
...
%             i=1
            ...
            [EV,OV,KV,UV,AV,AVB,TV,TVB] = ghu8_input(AC,A_1,A_2,TC,TCb,T_1,T_2,T_1b,T_2b,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [gw,hw] =  ghu8_halpha(AV,AVB,A_1,A_2,EV,KV,OV,TV,TVB,UV,alpha1,bobs,es,nc,np,p_i,sig,siga,wobs);
...
%             i=1
            ...
            [EV,OV,KV,UV,AV,AVB,TV,TVB] = ghu8_input(AC,A_1,A_2,TC,TCb,T_1,T_2,T_1b,T_2b,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [gw,hw] =  ghu8_htheta(AV,AVB,EV,KV,OV,TV,TVB,T_1,T_2,T_1b,T_2b,UV,alpha1,bobs,es,nc,np,p_i,sig,siga,wobs);
            ...
            H(k+sa,k+sa) = h(2,2);
            H(i+sa,k+sa) = h(1,2);
            H(i+sa,(sa+st+1):end)=h(1,end-(size(input,1)-(sa+st+1)):end);
            H(k+sa,(sa+st+1):end)=h(2,end-(size(input,1)-(sa+st+1)):end);
%             
...
%              i=1;
            ...
            [EV,OV,KV,UV,AV,AVB,TV,TVB] = ghu8_input(AC,A_1,A_2,TC,TCb,T_1,T_2,T_1b,T_2b,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [~,hw] =  ghu8_halpha_theta(AV,AVB,A_1,A_2,EV,TV,TVB,T_1,T_2,T_1b,T_2b,UV,alpha1,bobs,np,sig,siga,wobs);
