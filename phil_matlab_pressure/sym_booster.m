...
eval(subs(diff(ua,S),[alpha0,alpha1,theta1,S,pi,y],[30,.5,1,3,20,1000]))

eval(subs(ua,[alpha0,alpha1,theta1,S,pi,y],[30,.5,1,3,20,1000]))

eval(subs(ua,[alpha0,alpha1,theta1,S,pi,y],[30,.5,1,3+1,20,1000]))
