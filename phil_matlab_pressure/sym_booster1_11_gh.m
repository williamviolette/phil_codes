...
matlabFunction(simplify(wbp,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','wbp.m')
matlabFunction(simplify(bp,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','bp.m')

      
matlabFunction(simplify(log(wbp)+log(bp),'IgnoreAnalyticConstraints',true,'Steps',steps),'File','pout.m')
      
      
% matlabFunction(simplify(log(wbp)+log(bp),'IgnoreAnalyticConstraints',true,'Steps',steps),'File','pout.m')
      
gwp=jacobian(log(wbp),x)
hwp=jacobian(gwp,x)
   
matlabFunction(simplify(gwp,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','gwp.m','Optimize',false)
matlabFunction(simplify(hwp,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','hwp.m','Optimize',false)

gp=jacobian(log(bp),x)
hp=jacobian(gp,x)
   
matlabFunction(simplify(gp,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','gp.m','Optimize',false)
matlabFunction(simplify(hp,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','hp.m','Optimize',false)
