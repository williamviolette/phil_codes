...
ub = upnl(alpha0,alpha1,p_i,p_r,theta1,y-c);
un = upnl(alpha0,alpha1,p_i,p_r,theta1,y);

bobs=ub-un>epa;

wobs = wpnl(alpha0,alpha1,p_i,p_r,theta1) + ep;

given  = [alpha0; alpha1; sig; siga; theta1];

obj=@(input1)lbooster_gh2(input1,wobs,bobs,p_i,p_r,y,c,given);

input = .9.*[alpha0; alpha1; sig; siga];
