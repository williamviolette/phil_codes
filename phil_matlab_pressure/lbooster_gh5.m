function  [VAL,G,H] = lbooster_gh5(input,A,T,wobs,p_i,p_r,given)
...
%             i=1
            ...
            [valw,gw,hw] = gh5(AC,A_1,A_2,TC,T_1,T_2,alpha1,alpha0_1,alpha0_2,nc,np,p_i,p_r,sig,theta0_1,theta0_2,wobs);
...
%             i=1
            ...
            [~,gw,hw] = gh5(AC,A_1,A_2,TC,T_1,T_2,alpha1,alpha0_1,alpha0_2,nc,np,p_i,p_r,sig,theta0_1,theta0_2,wobs);
...
%             i=1;
            ...
            [~,~,hw] = gh5(AC,A_1,A_2,TC,T_1,T_2,alpha1,alpha0_1,alpha0_2,nc,np,p_i,p_r,sig,theta0_1,theta0_2,wobs);
