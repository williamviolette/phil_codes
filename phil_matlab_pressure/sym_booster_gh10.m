...
uab = subs(ua,[T_1,T_2,TC,y],[T_1b,T_2b,TCb,y - c]);
...
x = [alpha0_1; alpha0_2; theta0_1; theta0_2; alpha1; sig; c; siga ];
...
matlabFunction(obju1 + obju2 + obj,jj,hh,'File','ghu10.m',...
                    'Outputs',{'val','g','h'},'Optimize',true) % 77 sec with full + siga  
toc


                
matlabFunction(simplify(wa,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','wpnl10.m')
matlabFunction(simplify(ua,'IgnoreAnalyticConstraints',true,'Steps',steps),'File','upnl10.m')
