function  [VAL,G,H] = lbooster_gh9ns_t1(input,A,T,Tb,Tn,wobs,bobs,p_i,y,c,given)
...
%             i=1
            ...
            [EV,OV,KV,UV,AV,AVB,AVN,TV,TVB,TVN] = ghu9_input(AC,A_1,A_2,TC,TCb,TCn,T_1,T_2,T_1b,T_2b,T_1n,T_2n,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [valw,gw,hw] =  ghu9_s(AC,AVB,AVN,A_1,A_2,TCb,TCn,TVB,TVN,T_1b,T_2b,T_1n,T_2n,UV,alpha1,alpha0_1,alpha0_2,bobs,np,p_i,siga,theta0_1,theta0_2,y,yb);
...
%             i=1
            ...
            [EV,OV,KV,UV,AV,AVB,AVN,TV,TVB,TVN] = ghu9_input(AC,A_1,A_2,TC,TCb,TCn,T_1,T_2,T_1b,T_2b,T_1n,T_2n,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [~,gw,hw] =  ghu9_s(AC,AVB,AVN,A_1,A_2,TCb,TCn,TVB,TVN,T_1b,T_2b,T_1n,T_2n,UV,alpha1,alpha0_1,alpha0_2,bobs,np,p_i,siga,theta0_1,theta0_2,y,yb);
...
%             i=1;
            ...
            [EV,OV,KV,UV,AV,AVB,AVN,TV,TVB,TVN] = ghu9_input(AC,A_1,A_2,TC,TCb,TCn,T_1,T_2,T_1b,T_2b,T_1n,T_2n,alpha1,alpha0_1,alpha0_2,nc,p_i,sig,siga,theta0_1,theta0_2,wobs,y,yb);
            [~,~,hw] = ghu9_s(AC,AVB,AVN,A_1,A_2,TCb,TCn,TVB,TVN,T_1b,T_2b,T_1n,T_2n,UV,alpha1,alpha0_1,alpha0_2,bobs,np,p_i,siga,theta0_1,theta0_2,y,yb);
