function  [h,share_out] = lpressure5(input,Nobs,pi,pr,alpha0,alpha1,theta,y,mru_c,year,post,baD,SC,given)
...
u1 =  (gamma.*unl( 0  ,alpha0,alpha1,pi,pr,theta,y))/SC ;
u2 = ((gamma.*unl( 0  ,alpha0,alpha1,0 ,0 ,theta,y))-c)./SC ;
