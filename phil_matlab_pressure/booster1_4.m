...
obj=@(input1)lbooster1_4(input1,Bobs,wobs,p,y,SC,c,post,A,given);

obj1=@(input1)lbooster1_4sc(input1,Bobs,wobs,p,y,c,post,A,given);


input= [alpha0; sig; alpha1; theta1; theta2; theta3; SC]
obj1(input)
tic
out=fminunc(obj1,input)
toc
