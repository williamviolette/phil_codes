...
uab = subs(ua,[theta1,y],[T_1b+T_2b+T_3b,y-F]);
ua = subs(ua,[theta1],[T_2b]);
...
% 
% sub_set = [Eval,Oval,Kval,Uval,Aval,Avalb,Avaln,Tval,Tvalb,Tvaln];
% sub_var = [EV,OV,KV,UV,AV,AVB,AVN,TV,TVB,TVN];
% sub_name = {'EV','OV','KV','UV','AV','AVB','AVN','TV','TVB','TVN'};
% 
% tic 
% matlabFunction(Eval,Oval,Kval,Uval,Aval,Avalb,Avaln,Tval,Tvalb,Tvaln ...
%     ,'File','ghu9_input.m',...
