function [h,v,v_PS,v_CS]=sim_reps(welfare,Q0_PS,Q0_CS,pipe_age,total_loan,r,loan_term,nA,Aprime,A,beta,wm,we,wbar,t)
...
if welfare==1 || welfare==3
metric=1000;

    while metric > 1e-7
      [tv1,tdecis1]=max(util1_PS + util1_CS.*(1-(welfare==3)) + beta.*repmat(v,1,nA));
