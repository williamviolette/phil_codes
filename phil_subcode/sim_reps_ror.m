function [h,v,v_PS,v_CS]=sim_reps_ror(welfare,Q0_PS,Q0_CS,pipe_age,total_loan,r,loan_term,nA,Aprime,A,beta,wm,we,wbar,t,NRW)
...
util1_ROR =  ror.*F.*(PSt>=ror.*F).*(Aprime==0 & A>=loan_term*12) + ...
