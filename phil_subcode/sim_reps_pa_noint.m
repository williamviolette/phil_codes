...
util1_NRW = (NRW0 - (A.*NRW./pipe_age) - F).*(Aprime==0 & A>=loan_term*12) + ...
            (NRW0 - (A.*NRW./pipe_age) - F).*(Aprime==A+1 & Aprime<loan_term*12) + ... 
            (NRW0 - (A.*NRW./pipe_age)).*(Aprime==A+1 & Aprime>=loan_term*12) + ...
            -1000000.*(1-((Aprime==0 & A>loan_term*12)+(Aprime==A+1)));
