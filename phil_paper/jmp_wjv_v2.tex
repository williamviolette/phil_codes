...
\vspace{.05cm}
\footnotesize{ Standard errors are bootstrapped at the connection level.  Total Households:  \input{tables/totalhhsmm_group}  }
\end{table}
