...
% 	However, I find that these prices 
...
% 	In particular, I find that high marginal prices weaken incentives to share connections, 

% 	access and welfare by weakening incentives to share water.  




% 	or share with their neighbors' connections.  



% 	.  I then analyze the regulator's pricing problem: choosing fixed and marginal prices to maximize welfare while covering costs.


% 	With these estimates, I find that the presence of sharing reverses 

% 	At the same time, cities must choose relative fixed and marginal prices cover production costs by , 


% 	which have large implications for piped water access and usage.  Cities often subsidize


% 	 low fixed and high marginal prices to offset other connection costs and provide access especially for the poor; however, I find that 



% 	often leading them to use from low-quality vendors or share with their neighbors' connections. 




% 	In developing cities, households face many costs of connecting to piped water, often leading them to use from low-quality vendors or share with their neighbors' connections.  At the same time, many cities must set prices to cover production costs.  



% 	Many cities respond by adjusting fixed and marginal prices to ensure access while covering costs.  


	

% 	To ensure piped water access, cities are often constrained to adjusting fixed and marginal prices while covering production costs.  

% 	The primary way cities can respond is by  setting fixed and marginal prices still 

% 	respond by adjusting the fixed and marginal prices 


% 	Since water utilities must often cover their costs, cities are constrained to 



% 	With data from 1.5 million water connections in Manila, I structurally estimate household water demand to analyze optimal fixed and marginal prices for piped water in the presence of water sharing.  Cities often set low fixed and high marginal prices to offset other connection costs and provide access especially for the poor; however, I find that 

% 	To offset connection costs, cities often subsidize the fixed price with high marginal prices

% 	 to provide access especially for the poor; however,  


% 	Using data on 1.5 million water connections in Manila, I structurally estimate household water demand across three sources: purchasing directly from the provider, sharing with a neighbor's tap, or buying from a small-scale vendor.  

% to maximize welfare while covering their costs


% 	This paper analyzes how 


% 	To offset these connection costs, cities often subsidize their fixed connection fees with high marginal prices to provide access especially for the poor; however,  




% 	Public utilities choose fixed and marginal prices to recover costs.  
	
% 	This paper analyzes the welfare effects of pricing policies for piped water in the presence of water sharing.  


% 	Public utilities subsidize fixed connection fees with high marginal prices to provide access especially for the poor.  


% 	 but this policy can have the opposite effect when many households share connections.  



% 	The model predicts that low fixed fees and high marginal prices decrease access and welfare by weakening incentives to share water.  

% 	In contrast, the optimal pricing policy features a high fixed fee and low marginal price, increases shared connections, and ensures nearly universal access to piped water compared to current prices in Manila. 




% 	I establish that informal sharing networks provide \input{tables/shr_use_from_neighbor}\unskip\% 
% 	of total piped water access.   
...
% often increase the costs of purchasing a water connection particularly for disadvantaged households
...
%On top of the broad recommendation for high fixed fees and low marginal prices, the structural model also 


% lowering fixed fees and increasing block prices to improve access to piped water.
