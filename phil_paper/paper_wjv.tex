...
%	lead households to share a connection with their neighbors instead of purchasing their own connection.  
	...
	Households often share connections to public utilities with their neighbors in order to split set-up and maintenance costs.  This paper analyzes how sharing connections affects optimal pricing for water utilities.  With microdata from 1.5 million water connections in Manila, I estimate water demand in the presence of water sharing and solve for prices that maximize consumer surplus while funding production costs.  In practice, cities often set low fixed prices so that more households connect and high marginal prices to cover production costs.  Instead, the optimal policy uses high fixed prices to cover costs and low marginal prices to encourage greater consumption.  Sharing households split fixed prices and enjoy inexpensive piped water with their neighbors instead of using low-quality, non-piped water.  Counterfactual exercises find increases in shared connections, total piped water consumption, and social welfare from optimal prices compared to current prices in Manila.
...
%  For example, when households can easily share connections, public utilities can charge larger upfront fees for the same levels of access as when sharing is .  [UNCLEAR COMPARISON!!]

% Households also share connections to public utilities with their neighbors (piped water, electricity, mobile phones, etc.) especially in developing countries.\footnote{70\% of African water utilities report frequent sharing of water taps between households.  Over 14\% of urban households in Arba-Minch, Ethiopia report sourcing electricity from their neighbors instead of purchasing directly from the utility (\cite{mustefa2016energy}).  In South Africa as of 2012, 11.9\% of the population report sharing their mobile phone with others.  This percentage jumps to 19.9\% among those living in poverty (\cite{calandro2012mobile}).}   

% Connection sharing can have important implications for the optimal balance of fixed and marginal prices for these services.

% Understanding how this sharing behavior may affect optimal prices may have large consequences for public policy since governments actively regulate prices charged by public utilities.

% In developing countries, households often 
% Faced with fixed costs of accessing a good or service, consumers are increasingly .  
% In developing countries, these .    


Faced with high fixed costs of purchasing and maintaining durable goods, consumers often share these goods with each other.  While online platforms have accelerated peer-to-peer rentals of cars, apartments, and storage space (\cite{horton2016owning}), households in developing countries often share connections to public utilities like water and electricity with their neighbors.\footnote{70\% of African water utilities report frequent sharing of water taps between households.  Over 14\% of urban households in Arba-Minch, Ethiopia report sourcing electricity from their neighbors instead of purchasing directly from the utility (\cite{mustefa2016energy}).  In South Africa as of 2012, 11.9\% of the population report sharing their mobile phone with others.  This percentage jumps to 19.9\% among those living in poverty (\cite{calandro2012mobile}).}  Sharing can have large consequences for optimal pricing, particularly for public utilities.  Public utility pricing is especially salient in developing countries because prices must often be set to fully cover costs (\cite{laffont2005regulation}) and because prices determine not only monthly consumption, but also which households can access these basic services.  For example, when households cannot share connections, they may prefer relatively low fixed prices (ie. installation and maintenance fees) so that each household can afford a connection and high marginal prices (ie. prices per gallon or watt) to cover production costs.  However, when households can easily share connections, they may prefer splitting high fixed prices with their neighbors and enjoying low marginal prices from shared connections.  
%The optimal pricing policy depends both on consumer demand and on the costs of sharing connections between neighbors.

This paper focuses empirically on pricing piped water in Manila, Philippines to increase access and welfare when households share connections.  Improving access to piped water can generate substantial health benefits\footnote{\cite{zhang2016long,kosec2014child,gamper2010impact}, and \cite{galiani2005water} focus on health improvements in developing countries while \cite{cutler2005role} look historically at the US.} as well as improvements in household well-being through time savings and reduced intra-household conflict.\footnote{\cite{devoto2012happiness} provide water through a randomized-controlled trial in Morocco finding few health effects but large benefits to household welfare.}  Yet, the share of urban households without piped water has remained stable at 5\% for middle income countries and at 20\% for low income countries (World Bank [2015]).  While external health and other benefits may merit subsidizing piped water, any subsidies to public utilities are often limited by high costs of public funds and risk of regulatory capture in developing countries (\cite{laffont2005regulation}).  
