...
%Instead of piped water, these households often resort to local deepwells or water vendors.  CITE THE ADB HERE!
...
%  Without fixed prices, land-tenure requirements, or administrative expenses, these sources often have low costs of access.
...
\section{Tariff and Fee Structure}\label{appendix:connectionfeeamortization}
...
%Although the fixed fee listed on the bill increases for households consuming above 10 m3 as indicated in Figure~\ref{figure:tarifftrue}, the empirical strategy assumes one fixed fee at this higher level
%includes the fixed fee for households using above 10 m3 in the calculation since the bulk of 
