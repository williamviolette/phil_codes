...
\hspace{1em}High-skilled employment & \input{tables/good_job} \\
...
High-skilled employment & \input{tables/good_job_rs} \\
Lives in duplex& \input{tables/sub_rs} \\
Lives in single house& \input{tables/single_rs} \\
...
\midrule
Fixed Preferences & \\
\hspace{1em}Intercept & \input{tables/est_gamma_1_1} \\
 						& (\input{tables/est_gamma_sd_1_1}) \\
\hspace{1em}Household Size & \input{tables/est_gamma_2_1} \\
 							& (\input{tables/est_gamma_sd_2_1}) \\
\hspace{1em}Employed Household Members & \input{tables/est_gamma_3_1} \\
 						& (\input{tables/est_gamma_sd_3_1}) \\
\hspace{1em}High Skill Employment & \input{tables/est_gamma_4_1} \\
 						& (\input{tables/est_gamma_sd_4_1}) \\
\hspace{1em}Ever High Price & \input{tables/est_gamma_5_1} \\
 						& (\input{tables/est_gamma_sd_5_1}) \\
\hspace{1em}Pipe Replacement Area & \input{tables/est_gamma_6_1} \\
 						& (\input{tables/est_gamma_sd_6_1}) \\[.5em]
Price Sensitivity & \input{tables/est_alpha_1} \\
 						& (\input{tables/est_alpha_sd_1}) \\[.5em]
Service Quality Preferences & \\
\hspace{1em}Post Replacement & \input{tables/est_theta_1_1} \\
 						& (\input{tables/est_theta_sd_1_1}) \\
\hspace{1em}Booster Use & \input{tables/est_theta_2_1} \\
 							& (\input{tables/est_theta_sd_2_1}) \\
\hspace{1em}Post Replacement $\times$ Booster Use & \input{tables/est_theta_3_1} \\
 						& (\input{tables/est_theta_sd_3_1}) \\[.5em]
Usage Variability & \input{tables/est_sig_ep_1} \\
 						& (\input{tables/est_sig_ep_sd_1}) \\[.5em]
Booster Cost Variability & \input{tables/est_sig_up_1} \\
 						& (\input{tables/est_sig_up_sd_1}) \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\footnotesize
